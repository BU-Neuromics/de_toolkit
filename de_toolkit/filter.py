...
tokens = ("LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "OP", "WORD", "NUMBER") + reserved
    ...
    def __call__(self, mat):
        ...
        if self.field is None and self.group is None:
            ...
            if mat.column_data is None:
                raise Exception(
                    "Field specified, but no column data supplied, "
            ...
            if self.group is not None:
                ...
                if cols.size == 0:
                    warn(
                        f'Specified group value {self.field}=="{self.group}" was not found in '
